; ModuleID = 'condition_outside_block.c'
...
entry:
  ...
  call void @llvm.dbg.declare(metadata !{i32* %d}, metadata !22), !dbg !23
  %1 = load i32* %d, align 4, !dbg !24
  %cmp = icmp eq i32 %1, 1, !dbg !24
  br i1 %cmp, label %if.then, label %if.else, !dbg !24

if.then:                                          ; preds = %entry
  store i32* %a, i32** %c, align 8, !dbg !26
  br label %if.end, !dbg !28

if.else:                                          ; preds = %entry
  %arrayidx = getelementptr inbounds [4 x i32]* %b, i32 0, i64 1, !dbg !29
  store i32* %arrayidx, i32** %c, align 8, !dbg !29
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %2 = load i32** %c, align 8, !dbg !31
  %incdec.ptr = getelementptr inbounds i32* %2, i32 1, !dbg !31
  store i32* %incdec.ptr, i32** %c, align 8, !dbg !31
  ret void, !dbg !32
}
...
!0 = metadata !{i32 786449, metadata !1, i32 12, metadata !"clang version 3.4.2 (tags/RELEASE_34/dot2-final)", i1 false, metadata !"", i32 0, metadata !2, metadata !2, metadata !3, metadata !2, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/home/student/assign2/proper/condition_outside_block.c] [DW_LANG_C99]
!1 = metadata !{metadata !"condition_outside_block.c", metadata !"/home/student/assign2/proper"}
!2 = metadata !{i32 0}
...
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/student/assign2/proper/condition_outside_block.c]
...
!22 = metadata !{i32 786688, metadata !4, metadata !"d", metadata !5, i32 6, metadata !12, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [d] [line 6]
!23 = metadata !{i32 6, i32 0, metadata !4, null}
!24 = metadata !{i32 7, i32 0, metadata !25, null}
!25 = metadata !{i32 786443, metadata !1, metadata !4, i32 7, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/student/assign2/proper/condition_outside_block.c]
!26 = metadata !{i32 9, i32 0, metadata !27, null}
!27 = metadata !{i32 786443, metadata !1, metadata !25, i32 8, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/student/assign2/proper/condition_outside_block.c]
!28 = metadata !{i32 10, i32 0, metadata !27, null}
!29 = metadata !{i32 11, i32 0, metadata !30, null}
!30 = metadata !{i32 786443, metadata !1, metadata !25, i32 10, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/student/assign2/proper/condition_outside_block.c]
!31 = metadata !{i32 13, i32 0, metadata !4, null}
!32 = metadata !{i32 14, i32 0, metadata !4, null}
