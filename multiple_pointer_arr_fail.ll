; ModuleID = 'multiple_pointer_arr_fail.c'
...
entry:
  ...
  %incdec.ptr = getelementptr inbounds i32*** %0, i32 1, !dbg !26
  store i32*** %incdec.ptr, i32**** %d, align 8, !dbg !26
  %1 = load i32**** %d, align 8, !dbg !27
  %2 = load i32*** %1, align 8, !dbg !27
  %add.ptr = getelementptr inbounds i32** %2, i64 1, !dbg !27
  store i32** %add.ptr, i32*** %c, align 8, !dbg !27
  %3 = load i32**** %d, align 8, !dbg !28
  %4 = load i32*** %3, align 8, !dbg !28
  %5 = load i32** %4, align 8, !dbg !28
  %add.ptr1 = getelementptr inbounds i32* %5, i64 1, !dbg !28
  store i32* %add.ptr1, i32** %b, align 8, !dbg !28
  ret void, !dbg !29
}
...
!0 = metadata !{i32 786449, metadata !1, i32 12, metadata !"clang version 3.4.2 (tags/RELEASE_34/dot2-final)", i1 false, metadata !"", i32 0, metadata !2, metadata !2, metadata !3, metadata !2, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/media/sf_shared_cs4239/cs4239_assignment2/multiple_pointer_arr_fail.c] [DW_LANG_C99]
!1 = metadata !{metadata !"multiple_pointer_arr_fail.c", metadata !"/media/sf_shared_cs4239/cs4239_assignment2"}
!2 = metadata !{i32 0}
...
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/media/sf_shared_cs4239/cs4239_assignment2/multiple_pointer_arr_fail.c]
